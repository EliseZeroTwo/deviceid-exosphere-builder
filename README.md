...
1. Write down the *DeviceID*, without the initial `NX-` and the `-0` (or whatever there is) at the end. For instance, if it says: `NX-1122334455667788-0`, your device would be: `1122334455667788`
